        ...
        <div class="flex items-center space-x-8">
          ...
          <nav class="hidden md:flex space-x-6">
            <a class="nav-btn font-medium hover:text-orange-500 transition"
              style="color: #68420F;"
              href="index.php?page=inicio">Inicio</a>

            <a class="nav-btn font-medium hover:text-orange-500 transition"
              style="color: #68420F;"
              href="index.php?page=reservas">Reservas</a>

            <a class="nav-btn font-medium hover:text-orange-500 transition"
              style="color: #68420F;"
              href="index.php?page=dinosaurios">Dinosaurios</a>

            <a class="nav-btn font-medium hover:text-orange-500 transition"
              style="color: #68420F;"
              href="index.php?page=experiencias">Experiencias</a>
            ...
            <a class="nav-btn font-medium hover:text-orange-500 transition"
              style="color: #68420F;"
              href="index.php?page=eventos">Eventos</a>
          </nav>
        </div>

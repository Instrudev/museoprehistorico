   ...
   <header class="w-full bg-white border-b-2 border-gray-100 py-4 px-6" style="margin-top: 60px;">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
     <div class="flex items-center space-x-8">
      ...
      <nav class="hidden md:flex space-x-6"><a class="nav-btn font-medium hover:text-orange-500 transition" style="color: #68420F;" data-section="inicio" href="/public/index.php?page=inicio">Inicio</a> <a class="nav-btn font-medium hover:text-orange-500 transition" style="color: #68420F;" data-section="reservas" href="/public/index.php?page=reservas">Reservas</a> <a class="nav-btn font-medium hover:text-orange-500 transition" style="color: #68420F;" data-section="dinosaurios" href="/public/index.php?page=dinosaurios">Dinosaurios</a> <a class="nav-btn font-medium hover:text-orange-500 transition" style="color: #68420F;" data-section="experiencias" href="/public/index.php?page=experiencias">Experiencias</a> <a class="nav-btn font-medium hover:text-orange-500 transition" style="color: #68420F;" data-section="mapa" href="/public/index.php?page=mapa">Mapa</a> <a class="nav-btn font-medium hover:text-orange-500 transition" style="color: #68420F;" data-section="tarifas" href="/public/index.php?page=tarifas">Tarifas</a> <a class="nav-btn font-medium hover:text-orange-500 transition" style="color: #68420F;" data-section="eventos" href="/public/index.php?page=eventos">Eventos</a>
      </nav>
     </div>
    </div>
